...
for a in range(0, 10):
    ...
    for i in listproduk:
        ...
        # word = pd.read_csv('/home/ubuntu/shopeemakanan.csv', encoding='cp1252', names=["words"])
        ...
        if kategori[1].text != 'Makanan & Minuman' or kategori[2].text == 'Bahan Kue' or kategori[2].text == 'Bahan & Bumbu Masakan':
            continue
